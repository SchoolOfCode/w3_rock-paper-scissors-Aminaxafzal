...
//cashing the dom means storing something for future use, storing all of this 
//date into variables so we can use it later
...
function win(userChoice, computerChoice) {
   userScore++;
   // going back into the html where the score is displayed because we already
   // set the span 
